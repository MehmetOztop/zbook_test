class ZCL_ZMO_ODATA_01_MPC definition
  public
...
public section.
  ...
  types:
        ...
        SAYI2 type /IWBEP/SB_ODATA_TY_INT2,
        SAYI1 type /IWBEP/SB_ODATA_TY_INT2,
  ...
  types:
         TS_HEADER type ZODATA_S_HEADER .
  types:
    TT_HEADER type standard table of TS_HEADER .
  types:
         TS_ITEM type ZODATA_S_ITEM .
  types:
  ...
  types:
      begin of TS_FILE,
     FILENAME type C length 30,
  end of TS_FILE .
  types:
    TT_FILE type standard table of TS_FILE .
  types:
   TS_ZODATA_DDL006TYPE type ZODATA_CDS006 .
  types:
   TT_ZODATA_DDL006TYPE type standard table of TS_ZODATA_DDL006TYPE .
  ...
  constants GC_ZODATA_DDL006TYPE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'zodata_ddl006Type' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZMO_ODATA_01_MPC==========CP' ##NO_TEXT.
...
CLASS ZCL_ZMO_ODATA_01_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZMO_ODATA_01_SRV' ).
...
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'Sayi2'    iv_abap_fieldname = 'SAYI2' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_int16( ).
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'Sayi1'    iv_abap_fieldname = 'SAYI1' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_int16( ).
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZMO_ODATA_01_MPC=>TS_DEMOFUNCIMPORT' ). "#EC NOTEXT
  endmethod.
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'HeaderToItemNav' "#EC NOTEXT
                                                              iv_abap_fieldname = 'HEADERTOITEMNAV' "#EC NOTEXT
                                                              iv_association_name = 'HeaderToItemAsso' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZMO_ODATA_01_MPC=>TS_FILE' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Bsart' iv_abap_fieldname = 'BSART' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 4 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZODATA_S_HEADER'
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZMO_ODATA_01_MPC=>TS_HT001' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Txz01' iv_abap_fieldname = 'TXZ01' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZODATA_S_ITEM'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZMO_ODATA_01_MPC=>TS_RETURN' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20220413143413'.                  "#EC NOTEXT
...
*   4
*&---------------------------------------------------------------------*
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20220413153414'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20220413153414'.
    DATA(lv_sadl_xml) =
   ...
   ro_model_exposure = cl_sadl_gw_model_exposure=>get_exposure_xml( iv_uuid      = CONV #( 'ZMO_ODATA_01' )
