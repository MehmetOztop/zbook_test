class ZCL_ZMO_ODATA_01_DPC definition
  public
...
protected section.
  ...
  methods ZODATA_DDL006_UPDATE_ENTITY
    importing
    ...
    exporting
      !ER_ENTITY type ZCL_ZMO_ODATA_01_MPC=>TS_ZODATA_DDL006TYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZODATA_DDL006_GET_ENTITYSET
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZMO_ODATA_01_MPC=>TT_ZODATA_DDL006TYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZODATA_DDL006_GET_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZODATA_DDL006_DELETE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZODATA_DDL006_CREATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
  ...
  methods RETURNSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZMO_ODATA_01_MPC=>TS_RETURN
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods RETURNSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZMO_ODATA_01_MPC=>TT_RETURN
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods ITEMSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZMO_ODATA_01_MPC=>TS_ITEM
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ITEMSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZMO_ODATA_01_MPC=>TT_ITEM
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods HT001SET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZMO_ODATA_01_MPC=>TS_HT001
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods HT001SET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZMO_ODATA_01_MPC=>TT_HT001
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods HEADERSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZMO_ODATA_01_MPC=>TS_HEADER
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods HEADERSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZMO_ODATA_01_MPC=>TT_HEADER
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods FILESET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZMO_ODATA_01_MPC=>TS_FILE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods FILESET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZMO_ODATA_01_MPC=>TT_FILE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZMO_ODATA_01_DPC IMPLEMENTATION.
...
*&* This class has been generated on 13.04.2022 18:34:17 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZMO_ODATA_01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA zodata_ddl006_create_entity TYPE zcl_zmo_odata_01_mpc=>ts_zodata_ddl006type.
 DATA headerset_create_entity TYPE zcl_zmo_odata_01_mpc=>ts_header.
 DATA fileset_create_entity TYPE zcl_zmo_odata_01_mpc=>ts_file.
 DATA returnset_create_entity TYPE zcl_zmo_odata_01_mpc=>ts_return.
 DATA itemset_create_entity TYPE zcl_zmo_odata_01_mpc=>ts_item.
 DATA ht001set_create_entity TYPE zcl_zmo_odata_01_mpc=>ts_ht001.
...
*-------------------------------------------------------------------------*
*             EntitySet -  zodata_ddl006
*-------------------------------------------------------------------------*
     WHEN 'zodata_ddl006'.
*     Call the entity set generated method
    zodata_ddl006_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
       	 ...
       	 IMPORTING er_entity          = zodata_ddl006_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = zodata_ddl006_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA ht001set_get_entity TYPE zcl_zmo_odata_01_mpc=>ts_ht001.
 DATA returnset_get_entity TYPE zcl_zmo_odata_01_mpc=>ts_return.
 DATA itemset_get_entity TYPE zcl_zmo_odata_01_mpc=>ts_item.
 DATA fileset_get_entity TYPE zcl_zmo_odata_01_mpc=>ts_file.
 DATA zodata_ddl006_get_entity TYPE zcl_zmo_odata_01_mpc=>ts_zodata_ddl006type.
 DATA headerset_get_entity TYPE zcl_zmo_odata_01_mpc=>ts_header.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
          zodata_ddl006_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = zodata_ddl006_get_entity
                         es_response_context = es_response_context
          ).

        IF zodata_ddl006_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = zodata_ddl006_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZMO_ODATA_01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA ht001set_get_entityset TYPE zcl_zmo_odata_01_mpc=>tt_ht001.
 DATA returnset_get_entityset TYPE zcl_zmo_odata_01_mpc=>tt_return.
 DATA itemset_get_entityset TYPE zcl_zmo_odata_01_mpc=>tt_item.
 DATA fileset_get_entityset TYPE zcl_zmo_odata_01_mpc=>tt_file.
 DATA zodata_ddl006_get_entityset TYPE zcl_zmo_odata_01_mpc=>tt_zodata_ddl006type.
 DATA headerset_get_entityset TYPE zcl_zmo_odata_01_mpc=>tt_header.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
      zodata_ddl006_get_entityset(
        EXPORTING
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = zodata_ddl006_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = zodata_ddl006_get_entityset
        CHANGING
          cr_data = er_entityset
      ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA ht001set_update_entity TYPE zcl_zmo_odata_01_mpc=>ts_ht001.
 DATA itemset_update_entity TYPE zcl_zmo_odata_01_mpc=>ts_item.
 DATA returnset_update_entity TYPE zcl_zmo_odata_01_mpc=>ts_return.
 DATA fileset_update_entity TYPE zcl_zmo_odata_01_mpc=>ts_file.
 DATA headerset_update_entity TYPE zcl_zmo_odata_01_mpc=>ts_header.
 DATA zodata_ddl006_update_entity TYPE zcl_zmo_odata_01_mpc=>ts_zodata_ddl006type.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*     Call the entity set generated method
          zodata_ddl006_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = zodata_ddl006_update_entity
          ).
       IF zodata_ddl006_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = zodata_ddl006_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
ENDLOOP.
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    TYPES ty_zodata_ddl006_1 TYPE zodata_ddl006 ##NEEDED. " reference for where-used list

    DATA(lv_sadl_xml) =
               |<?xml version="1.0" encoding="utf-16"?>| &
               |<sadl:definition xmlns:sadl="http://sap.com/sap.nw.f.sadl" syntaxVersion="V2" >| &
               | <sadl:dataSource type="CDS" name="ZODATA_DDL006" binding="ZODATA_DDL006" />| &
               |<sadl:resultSet>| &
               |<sadl:structure name="zodata_ddl006" dataSource="ZODATA_DDL006" maxEditMode="RO" exposure="TRUE" >| &
    ...
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = 20220413153414
               iv_uuid              = 'ZMO_ODATA_01'
  ...
  method ZODATA_DDL006_CREATE_ENTITY.
  ...
  method ZODATA_DDL006_UPDATE_ENTITY.
